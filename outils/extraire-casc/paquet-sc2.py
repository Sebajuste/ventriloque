...
#   4. `monter-voix`            -> une reference .wav de trente secondes par personnage
#   5. le zip, au format que `packs.rs` sait installer
#
# Usage :
#   python outils\extraire-casc\paquet-sc2.py
#   python outils\extraire-casc\paquet-sc2.py --jeu "D:\Jeux\StarCraft II" --travail D:\tmp\sc2
#   python outils\extraire-casc\paquet-sc2.py --reprendre   (garde l'inventaire deja etabli)
...
MONTEUR = os.path.join(RACINE, "outils", "monter-voix", "target", "release", "monter-voix.exe")
